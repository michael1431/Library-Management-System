...
<div class="wrapper">
  ...
  <header class="main-header">
      ...
      <a href="my_issued_books.php" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b></b>LMS</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
         ...
         <li class="active treeview">
            ...
            <i class="fa fa-book"></i> <span>Issue Books</span>
        ...
        <li class="active treeview">
            ...
            <i class="fa fa-book"></i> <span>Student Profile</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
...
?><span style="color: red;">Message From Librarian <?php echo $std_read;?></span>
<?php
