...
<?php
                    ...
                    if(isset($_POST['login'])){
                        ...
                        $username_check = mysqli_query($link,"SELECT * FROM `librarian_registration` WHERE `username` = '$username'");
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-sm-offset-4">
                    ...
                    <form action="login.php" method="POST">
                        <h2 class="text-center alert alert-success">Librarian Login Form</h2>
